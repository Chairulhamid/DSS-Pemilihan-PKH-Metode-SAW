                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($role as $r) : ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $r['role']; ?></td>
                                            <td>
                                                <a href="<?= base_url('admin/roleakses/') . $r['id']; ?>" class="label btn-round btn-success">akses</a>
                                                <a href="" class="label btn-round btn-warning" data-toggle="modal" data-target="#modalEditRole<?= $r['id']; ?>">edit</a>
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($menu as $m) : ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $m['menu']; ?></td>
                                            <td>
                                                <a href="" class="label btn-round btn-warning" data-toggle="modal" data-target="#modalEditMenu<?= $m['id']; ?>">edit</a>
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($submenu as $sm) : ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $sm['is_active']; ?></td>
                                            <td>
                                                <a href="" class="label btn-round btn-warning" data-toggle="modal" data-target="#modalEditSubmenu<?= $sm['id']; ?>">edit</a>
