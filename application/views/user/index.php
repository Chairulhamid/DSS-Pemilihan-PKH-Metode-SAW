    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-7 col-xs-7">
                ...
                <a href="<?= base_url('user/editUser') ?>" class="btn btn-round btn-primary mb-3" > Edit Profile</a>
                <a href="<?= base_url('user/ubahPassword') ?>" class="btn btn-round btn-warning mb-3" > Ubah Password</a>
                </div>
            </div>
        </div>
    </div>
